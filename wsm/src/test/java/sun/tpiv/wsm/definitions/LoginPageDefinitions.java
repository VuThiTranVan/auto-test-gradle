...
public class LoginPageDefinitions extends AbstractTestNGCucumberTests {
	...
	public void verifyLogin() {
		String homePageHeading = driver
				.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[1]/header/div[1]/div[2]/ul/li/span/p")).getText();

		// Verify new page - HomePage
		Assert.assertNotEquals(homePageHeading, "");
	}
